...
public interface NotaCreditoDetalleRepository
    ...
    @Query(
        value = "select notaCreditoDetalle from NotaCreditoDetalle notaCreditoDetalle left join fetch notaCreditoDetalle.notaCredito left join fetch notaCreditoDetalle.producto",
        countQuery = "select count(notaCreditoDetalle) from NotaCreditoDetalle notaCreditoDetalle"
    )
    Page<NotaCreditoDetalle> findAllWithToOneRelationships(Pageable pageable);

    @Query(
        "select notaCreditoDetalle from NotaCreditoDetalle notaCreditoDetalle left join fetch notaCreditoDetalle.notaCredito left join fetch notaCreditoDetalle.producto"
    )
