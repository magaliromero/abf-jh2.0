...
public class Clientes implements Serializable {
    ...
    public Clientes ruc(String ruc) {
        this.setRuc(ruc);
        return this;
    }
    ...
    public Clientes razonSocial(String razonSocial) {
    ...
    public Clientes documento(String documento) {
    ...
    public Clientes fechaNacimiento(LocalDate fechaNacimiento) {
