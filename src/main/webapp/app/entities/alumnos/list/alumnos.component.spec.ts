...
describe('Alumnos Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'alumnos', component: AlumnosComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to alumnosService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getAlumnosIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getAlumnosIdentifier).toHaveBeenCalledWith(entity);
