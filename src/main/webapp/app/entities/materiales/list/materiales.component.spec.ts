...
describe('Materiales Management Component', () => {
  let comp: MaterialesComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(MaterialesComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.materiales?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to materialesService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getMaterialesIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getMaterialesIdentifier).toHaveBeenCalledWith(entity);
