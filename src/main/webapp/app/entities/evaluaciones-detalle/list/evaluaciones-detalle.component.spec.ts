...
describe('EvaluacionesDetalle Management Component', () => {
  let comp: EvaluacionesDetalleComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(EvaluacionesDetalleComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.evaluacionesDetalles?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to evaluacionesDetalleService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getEvaluacionesDetalleIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getEvaluacionesDetalleIdentifier).toHaveBeenCalledWith(entity);
