...
describe('Cursos Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'cursos', component: CursosComponent }]), HttpClientTestingModule, CursosComponent],
      providers: [
        {
  ...
  describe('trackId', () => {
    it('Should forward to cursosService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCursosIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCursosIdentifier).toHaveBeenCalledWith(entity);
