...
describe('RegistroClases routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return IRegistroClases returned by find', () => {
      // GIVEN
      ...
      expect(resultRegistroClases).toEqual({ id: 123 });
    });
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultRegistroClases).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IRegistroClases>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
      ...
      // THEN
      expect(service.find).toBeCalledWith(123);
      expect(resultRegistroClases).toEqual(undefined);
