...
describe('Sucursales Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(SucursalesComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.sucursales?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to sucursalesService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getSucursalesIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getSucursalesIdentifier).toHaveBeenCalledWith(entity);
