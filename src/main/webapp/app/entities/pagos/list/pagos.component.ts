...
import { EntityArrayResponseType, PagosService } from '../service/pagos.service';
...
export class PagosComponent implements OnInit {
  ...
  trackId = (_index: number, item: IPagos): number => this.pagosService.getPagosIdentifier(item);
  ...
  protected fillComponentAttributesFromResponseBody(data: IPagos[] | null): IPagos[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.pagosService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
