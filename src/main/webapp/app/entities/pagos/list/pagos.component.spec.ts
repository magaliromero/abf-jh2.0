...
describe('Pagos Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'pagos', component: PagosComponent }]), HttpClientTestingModule, PagosComponent],
      providers: [
        {
  ...
  describe('trackId', () => {
    it('Should forward to pagosService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPagosIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPagosIdentifier).toHaveBeenCalledWith(entity);
