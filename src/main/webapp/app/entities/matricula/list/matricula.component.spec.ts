...
describe('Matricula Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'matricula', component: MatriculaComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to matriculaService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getMatriculaIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getMatriculaIdentifier).toHaveBeenCalledWith(entity);
