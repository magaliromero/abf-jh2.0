...
import { EntityArrayResponseType, MatriculaService } from '../service/matricula.service';
...
export class MatriculaComponent implements OnInit {
  ...
  trackId = (_index: number, item: IMatricula): number => this.matriculaService.getMatriculaIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.matriculas = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IMatricula[] | null): IMatricula[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.matriculaService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
