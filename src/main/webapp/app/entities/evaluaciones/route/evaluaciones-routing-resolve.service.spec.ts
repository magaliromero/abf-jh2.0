...
describe('Evaluaciones routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return IEvaluaciones returned by find', () => {
      // GIVEN
      ...
      expect(resultEvaluaciones).toEqual({ id: 123 });
    });
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultEvaluaciones).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IEvaluaciones>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
      ...
      // THEN
      expect(service.find).toBeCalledWith(123);
      expect(resultEvaluaciones).toEqual(undefined);
