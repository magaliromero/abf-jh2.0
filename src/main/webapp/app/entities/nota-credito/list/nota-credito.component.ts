...
export class NotaCreditoComponent implements OnInit {
  ...
  delete(notaCredito: INotaCredito): void {
    const modalRef = this.modalService.open(NotaCreditoDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.notaCredito = notaCredito;
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.notaCreditos = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: INotaCredito[] | null): INotaCredito[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.notaCreditoService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
