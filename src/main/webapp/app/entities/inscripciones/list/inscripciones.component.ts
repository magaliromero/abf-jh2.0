...
import { EntityArrayResponseType, InscripcionesService } from '../service/inscripciones.service';
...
export class InscripcionesComponent implements OnInit {
  ...
  trackId = (_index: number, item: IInscripciones): number => this.inscripcionesService.getInscripcionesIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.inscripciones = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IInscripciones[] | null): IInscripciones[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.inscripcionesService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
