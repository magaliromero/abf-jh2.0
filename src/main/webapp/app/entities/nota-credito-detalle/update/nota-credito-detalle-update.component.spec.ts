...
describe('NotaCreditoDetalle Management Update Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [NotaCreditoDetalleUpdateComponent],
      providers: [
        FormBuilder,
        {
  ...
  describe('ngOnInit', () => {
    it('Should call NotaCredito query and add missing value', () => {
      ...
      const notaCredito: INotaCredito = { id: 18197 };
      notaCreditoDetalle.notaCredito = notaCredito;

      const notaCreditoCollection: INotaCredito[] = [{ id: 46578 }];
    ...
    it('Should call Productos query and add missing value', () => {
      const notaCreditoDetalle: INotaCreditoDetalle = { id: 456 };
      const producto: IProductos = { id: 35284 };
      notaCreditoDetalle.producto = producto;

      const productosCollection: IProductos[] = [{ id: 87546 }];
    ...
    it('Should update editForm', () => {
      const notaCreditoDetalle: INotaCreditoDetalle = { id: 456 };
      const notaCredito: INotaCredito = { id: 3741 };
      notaCreditoDetalle.notaCredito = notaCredito;
      const producto: IProductos = { id: 45108 };
      notaCreditoDetalle.producto = producto;
