...
describe('Funcionarios Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'funcionarios', component: FuncionariosComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to funcionariosService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getFuncionariosIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getFuncionariosIdentifier).toHaveBeenCalledWith(entity);
