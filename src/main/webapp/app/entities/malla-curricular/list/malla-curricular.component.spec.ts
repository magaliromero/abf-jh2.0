...
describe('MallaCurricular Management Component', () => {
  let comp: MallaCurricularComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'malla-curricular', component: MallaCurricularComponent }]),
      ...
      .overrideTemplate(MallaCurricularComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.mallaCurriculars?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to mallaCurricularService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getMallaCurricularIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getMallaCurricularIdentifier).toHaveBeenCalledWith(entity);
