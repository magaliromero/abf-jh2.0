...
export const facturaDetalleResolve = (route: ActivatedRouteSnapshot): Observable<null | IFacturaDetalle> => {
  const id = route.params['id'];
  if (id) {
    return inject(FacturaDetalleService)
      .find(id)
      .pipe(
...
export default facturaDetalleResolve;
