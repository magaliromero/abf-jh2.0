...
import { EntityArrayResponseType, FacturaDetalleService } from '../service/factura-detalle.service';
...
export class FacturaDetalleComponent implements OnInit {
  ...
  trackId = (_index: number, item: IFacturaDetalle): number => this.facturaDetalleService.getFacturaDetalleIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.facturaDetalles = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IFacturaDetalle[] | null): IFacturaDetalle[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.facturaDetalleService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
