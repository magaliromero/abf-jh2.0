...
describe('FacturaDetalle Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'factura-detalle', component: FacturaDetalleComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.facturaDetalles?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to facturaDetalleService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getFacturaDetalleIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getFacturaDetalleIdentifier).toHaveBeenCalledWith(entity);
