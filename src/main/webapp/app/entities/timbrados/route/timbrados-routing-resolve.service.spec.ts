...
describe('Timbrados routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return ITimbrados returned by find', () => {
      // GIVEN
      ...
      expect(resultTimbrados).toEqual({ id: 123 });
    });
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultTimbrados).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ITimbrados>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
      ...
      // THEN
      expect(service.find).toBeCalledWith(123);
      expect(resultTimbrados).toEqual(undefined);
