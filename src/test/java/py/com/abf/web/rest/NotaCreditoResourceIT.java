...
class NotaCreditoResourceIT {
    ...
    void createNotaCredito() throws Exception {
        ...
        assertThat(testNotaCredito.getTimbrado()).isEqualTo(DEFAULT_TIMBRADO);
        ...
        assertThat(testNotaCredito.getEstado()).isEqualTo(DEFAULT_ESTADO);
    ...
    @Test
    @Transactional
    void getAllNotaCreditosByTimbradoIsEqualToSomething() throws Exception {
        // Initialize the database
        notaCreditoRepository.saveAndFlush(notaCredito);

        // Get all the notaCreditoList where timbrado equals to DEFAULT_TIMBRADO
        defaultNotaCreditoShouldBeFound("timbrado.equals=" + DEFAULT_TIMBRADO);

        // Get all the notaCreditoList where timbrado equals to UPDATED_TIMBRADO
        defaultNotaCreditoShouldNotBeFound("timbrado.equals=" + UPDATED_TIMBRADO);
    }

    @Test
    @Transactional
    void getAllNotaCreditosByTimbradoIsInShouldWork() throws Exception {
        // Initialize the database
        notaCreditoRepository.saveAndFlush(notaCredito);

        // Get all the notaCreditoList where timbrado in DEFAULT_TIMBRADO or UPDATED_TIMBRADO
        defaultNotaCreditoShouldBeFound("timbrado.in=" + DEFAULT_TIMBRADO + "," + UPDATED_TIMBRADO);

        // Get all the notaCreditoList where timbrado equals to UPDATED_TIMBRADO
        defaultNotaCreditoShouldNotBeFound("timbrado.in=" + UPDATED_TIMBRADO);
    }

    @Test
    @Transactional
    void getAllNotaCreditosByTimbradoIsNullOrNotNull() throws Exception {
        // Initialize the database
        notaCreditoRepository.saveAndFlush(notaCredito);

        // Get all the notaCreditoList where timbrado is not null
        defaultNotaCreditoShouldBeFound("timbrado.specified=true");

        // Get all the notaCreditoList where timbrado is null
        defaultNotaCreditoShouldNotBeFound("timbrado.specified=false");
    }

    @Test
    @Transactional
    void getAllNotaCreditosByTimbradoIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        notaCreditoRepository.saveAndFlush(notaCredito);

        // Get all the notaCreditoList where timbrado is greater than or equal to DEFAULT_TIMBRADO
        defaultNotaCreditoShouldBeFound("timbrado.greaterThanOrEqual=" + DEFAULT_TIMBRADO);

        // Get all the notaCreditoList where timbrado is greater than or equal to UPDATED_TIMBRADO
        defaultNotaCreditoShouldNotBeFound("timbrado.greaterThanOrEqual=" + UPDATED_TIMBRADO);
    }

    @Test
    @Transactional
    void getAllNotaCreditosByTimbradoIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        notaCreditoRepository.saveAndFlush(notaCredito);

        // Get all the notaCreditoList where timbrado is less than or equal to DEFAULT_TIMBRADO
        defaultNotaCreditoShouldBeFound("timbrado.lessThanOrEqual=" + DEFAULT_TIMBRADO);

        // Get all the notaCreditoList where timbrado is less than or equal to SMALLER_TIMBRADO
        defaultNotaCreditoShouldNotBeFound("timbrado.lessThanOrEqual=" + SMALLER_TIMBRADO);
    }

    @Test
    @Transactional
    void getAllNotaCreditosByTimbradoIsLessThanSomething() throws Exception {
        // Initialize the database
        notaCreditoRepository.saveAndFlush(notaCredito);

        // Get all the notaCreditoList where timbrado is less than DEFAULT_TIMBRADO
        defaultNotaCreditoShouldNotBeFound("timbrado.lessThan=" + DEFAULT_TIMBRADO);

        // Get all the notaCreditoList where timbrado is less than UPDATED_TIMBRADO
        defaultNotaCreditoShouldBeFound("timbrado.lessThan=" + UPDATED_TIMBRADO);
    }

    @Test
    @Transactional
    void getAllNotaCreditosByTimbradoIsGreaterThanSomething() throws Exception {
        // Initialize the database
        notaCreditoRepository.saveAndFlush(notaCredito);

        // Get all the notaCreditoList where timbrado is greater than DEFAULT_TIMBRADO
        defaultNotaCreditoShouldNotBeFound("timbrado.greaterThan=" + DEFAULT_TIMBRADO);

        // Get all the notaCreditoList where timbrado is greater than SMALLER_TIMBRADO
        defaultNotaCreditoShouldBeFound("timbrado.greaterThan=" + SMALLER_TIMBRADO);
    }
    ...
    @Test
    @Transactional
    void getAllNotaCreditosByEstadoIsEqualToSomething() throws Exception {
        // Initialize the database
        notaCreditoRepository.saveAndFlush(notaCredito);

        // Get all the notaCreditoList where estado equals to DEFAULT_ESTADO
        defaultNotaCreditoShouldBeFound("estado.equals=" + DEFAULT_ESTADO);

        // Get all the notaCreditoList where estado equals to UPDATED_ESTADO
        defaultNotaCreditoShouldNotBeFound("estado.equals=" + UPDATED_ESTADO);
    }

    @Test
    @Transactional
    void getAllNotaCreditosByEstadoIsInShouldWork() throws Exception {
        // Initialize the database
        notaCreditoRepository.saveAndFlush(notaCredito);

        // Get all the notaCreditoList where estado in DEFAULT_ESTADO or UPDATED_ESTADO
        defaultNotaCreditoShouldBeFound("estado.in=" + DEFAULT_ESTADO + "," + UPDATED_ESTADO);

        // Get all the notaCreditoList where estado equals to UPDATED_ESTADO
        defaultNotaCreditoShouldNotBeFound("estado.in=" + UPDATED_ESTADO);
    }

    @Test
    @Transactional
    void getAllNotaCreditosByEstadoIsNullOrNotNull() throws Exception {
        // Initialize the database
        notaCreditoRepository.saveAndFlush(notaCredito);

        // Get all the notaCreditoList where estado is not null
        defaultNotaCreditoShouldBeFound("estado.specified=true");

        // Get all the notaCreditoList where estado is null
        defaultNotaCreditoShouldNotBeFound("estado.specified=false");
    }
    ...
    void putExistingNotaCredito() throws Exception {
        ...
        NotaCredito updatedNotaCredito = notaCreditoRepository.findById(notaCredito.getId()).get();
        ...
        assertThat(testNotaCredito.getTimbrado()).isEqualTo(UPDATED_TIMBRADO);
        ...
        assertThat(testNotaCredito.getEstado()).isEqualTo(UPDATED_ESTADO);
    ...
    void partialUpdateNotaCreditoWithPatch() throws Exception {
        ...
        partialUpdatedNotaCredito.fecha(UPDATED_FECHA).notaNro(UPDATED_NOTA_NRO).estado(UPDATED_ESTADO);
