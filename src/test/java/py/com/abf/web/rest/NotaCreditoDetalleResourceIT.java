...
class NotaCreditoDetalleResourceIT {
    ...
    void putExistingNotaCreditoDetalle() throws Exception {
        ...
        NotaCreditoDetalle updatedNotaCreditoDetalle = notaCreditoDetalleRepository.findById(notaCreditoDetalle.getId()).orElseThrow();
    ...
    void partialUpdateNotaCreditoDetalleWithPatch() throws Exception {
        ...
        partialUpdatedNotaCreditoDetalle.cantidad(UPDATED_CANTIDAD).subtotal(UPDATED_SUBTOTAL).valorPorcentaje(UPDATED_VALOR_PORCENTAJE);
